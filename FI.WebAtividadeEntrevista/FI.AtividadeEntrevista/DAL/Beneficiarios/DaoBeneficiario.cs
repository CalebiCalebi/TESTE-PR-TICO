...
namespace FI.AtividadeEntrevista.DAL
{
    ...
    internal class DaoBeneficiario : AcessoDados
    {
        ...
        internal long Incluir(DML.Beneficiario Beneficiario)
        {
            ...
            parametros.Add(new System.Data.SqlClient.SqlParameter("CPF", Beneficiario.Nome));
            parametros.Add(new System.Data.SqlClient.SqlParameter("Nome", Beneficiario.CPF));
            parametros.Add(new System.Data.SqlClient.SqlParameter("IdCliente", Beneficiario.CPF));
        ...
        private List<DML.Beneficiario> Converter(DataSet ds)
        {
            ...
            if (ds != null && ds.Tables != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                foreach (DataRow row in ds.Tables[0].Rows)
                {
                    ...
                    bnf.IdCliente = row.Field<long>("IdClinte");
